...
struct ChessModelBinpack : Model {
    ...
    ChessModelBinpack(float lambda_)
        : lambda(lambda_) {}

    /**
     * @brief Set up inputs and outputs for the model.
     * Override this function to define inputs for the chess model.
     * @param positions Reference to a binpackloader::DataSet&
     * This function should be implemented in derived classes specify how inputs and outputs are
     * prepared.
     */
    ...
    void distribution(binpackloader::DataSet& loader, int batches = 32) {
